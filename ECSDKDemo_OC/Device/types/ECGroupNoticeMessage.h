...
typedef NS_ENUM(NSUInteger, ECGroupMessageType) {
     ...
     *  好友申请
     */
    ECGroupMessageType_ProposeFriend
};
 ...
 */
@property (nonatomic, retain) NSString *declared;
@property (nonatomic, retain) NSString *proposerName;
@property (nonatomic, retain) NSString *type;//nil，7，8 结果 9，组织加入成工-group  5-好友申请  6-好友申请结果 
