...
-(void)layoutSubviews{
    ...
    ECMediaMessageBody *mediaBody = (ECMediaMessageBody*)self.displayMessage.messageBody;
    if ([[NSFileManager defaultManager] fileExistsAtPath:mediaBody.localPath])
    {
        ...
        _lengthLabel.text = [NSString stringWithFormat:@"%d″",mediaBody.duration];
    ...
    if (self.isSender) {
        ...
        self.bubbleView.frame = CGRectMake(self.portraitImg.frame.origin.x-width-10.0f, self.portraitImg.frame.origin.y+20.f, width, 45.0f);
        ...
        self.bubbleView.frame = CGRectMake(self.portraitImg.frame.origin.x+10.0f+self.portraitImg.frame.size.width, self.portraitImg.frame.origin.y+20.f, width, 45.0f);
