...
@interface TLCommentViewController (){
    int currentPage;
    int pageCount;
    NSString *travelId;
    NSString *type;
...
@implementation TLCommentViewController
