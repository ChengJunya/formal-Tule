//
//  TLMyCollectionViewController.m
//  TL
//
...
#import "TLMyCollectionViewController.h"
#import "RUILabel.h"
#import "TLMineListItem.h"
#import "TLHelper.h"
#import "UserDataHelper.h"
#import "LoginRequestDTO.h"
@interface TLMyCollectionViewController (){
    CGFloat yOffSet;
}
@property (nonatomic,strong) UIScrollView *contentScrollView;
@end

@implementation TLMyCollectionViewController
...
//    yOffSet = yOffSet + CGRectGetHeight(labelLabel.frame)+vGap*2;
    ...
    NSArray *itemsData = @[
  @{@"ID":@"1",@"NAME":@"攻略",@"IMG":@"menu1_homepage",@"VCNAME":@"TLStrategyListViewController",@"TYPE":@"1",@"IS_SHOW_MENU":@"1",@"IS_SHOW_ADD":@"1",@"DATATYPE":@"2",@"LOGINID":loginId},
@{@"ID":@"2",@"NAME":@"路书",@"IMG":@"menu2_homepage",@"VCNAME":@"TLWayBookListViewController",@"TYPE":@"2",@"IS_SHOW_MENU":@"1",@"IS_SHOW_ADD":@"1",@"DATATYPE":@"2",@"LOGINID":loginId},
@{@"ID":@"3",@"NAME":@"游记",@"IMG":@"menu3_homepage",@"VCNAME":@"TLTripNoteListViewController",@"TYPE":@"3",@"IS_SHOW_MENU":@"1",@"IS_SHOW_ADD":@"1",@"DATATYPE":@"2",@"LOGINID":loginId},
@{@"ID":@"4",@"NAME":@"活动",@"IMG":@"menu4_homepage",@"VCNAME":@"TLGroupActivityListViewController",@"TYPE":@"4",@"IS_SHOW_MENU":@"1",@"IS_SHOW_ADD":@"1",@"DATATYPE":@"2",@"LOGINID":loginId},
@{@"ID":@"5",@"NAME":@"车讯",@"IMG":@"menu5_homepage",@"VCNAME":@"TLCarMainListViewController",@"TYPE":@"5",@"IS_SHOW_MENU":@"1",@"IS_SHOW_ADD":@"1",@"DATATYPE":@"2",@"LOGINID":loginId},
@{@"ID":@"6",@"NAME":@"跳蚤",@"IMG":@"menu6_homepage",@"VCNAME":@"TLSecondPlatformViewController",@"TYPE":@"6",@"IS_SHOW_MENU":@"1",@"IS_SHOW_ADD":@"1",@"DATATYPE":@"2",@"LOGINID":loginId},
@{@"ID":@"8",@"NAME":@"商家",@"IMG":@"menu8_homepage",@"VCNAME":@"TLStoreListViewController",@"TYPE":@"8",@"IS_SHOW_MENU":@"1",@"IS_SHOW_ADD":@"1",@"DATATYPE":@"2",@"LOGINID":loginId}];
