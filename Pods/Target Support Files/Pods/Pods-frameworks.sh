...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "Pods/AKSegmentedControl.framework"
  install_framework "Pods/CRToast.framework"
  install_framework "Pods/CWPopup.framework"
  install_framework "Pods/CustomActionsheet.framework"
  install_framework "Pods/DACircularProgress.framework"
  install_framework "Pods/IQKeyboardManager.framework"
  install_framework "Pods/ImagePlayerView.framework"
  install_framework "Pods/JSONModel.framework"
  install_framework "Pods/KVNMaskedPageControl.framework"
